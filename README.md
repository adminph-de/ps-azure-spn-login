...
```
>Check my usage of the code-snipe as an example at: http://github.code-snipes.de/ps-azure-spn-login/  I used it in the ``report.ps1``script to authenticate before run the script.
